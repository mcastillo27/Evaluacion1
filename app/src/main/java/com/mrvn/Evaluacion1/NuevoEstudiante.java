...
import static com.mrvn.Evaluacion1.MainActivity.contador;
import static com.mrvn.Evaluacion1.MainActivity.msjEstudiante;
public class NuevoEstudiante extends AppCompatActivity {
    ...
    public void Procesar() {
            ...
            enviar.putExtra(msjEstudiante,"Estudiante Ingresado con exito");
    ...
    public void ToastValidador2(){
        Toast.makeText(this,"Las notas deben de ser de 0 a 10.00",Toast.LENGTH_SHORT).show();
    }
}
